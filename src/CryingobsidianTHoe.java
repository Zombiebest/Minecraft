...
/*    */ 
public class CryingobsidianTHoe extends Item
{
    public CryingobsidianTHoe(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
        super(par1);
        this.maxStackSize = 1;
    ...
    public CryingobsidianTHoe(int var1, ToolMaterial var2)
    {
        super(var1);
        this.maxStackSize = 1;
